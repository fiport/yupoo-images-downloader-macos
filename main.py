if __name__ == "__main__":
	...
	class YupooDownloader():
                                            ...
                                            for img in self.albums[catalog][album]['imgs']:
                                                ...
                                                if os.path.exists(path):
                                                    ...
                                                    if os.path.exists(without_category_path):
                                                        ...
                                                        album_path = self.albums[catalog][album]
                                                        if 'category_title' in album_path:
                                                            save_path = os.path.join(OUTPUT_PATH, "fotos_yupoo", name_catalog, "categorias", album_path['category_title'])
                                                            target = self.normpath(os.path.join(OUTPUT_PATH, "fotos_yupoo", name_catalog, "albuns", album))  # The shortcut target file or folder
                                                            work_dir = self.normpath(os.path.join(OUTPUT_PATH, "fotos_yupoo", name_catalog, "albuns"))  # The parent folder of your file
		...
		async def get_imgs(self, r):
                    ...
                    symlink_path = os.path.join(save_path, f"{album}.symlink")
                    ...
                    try:
                        async with aiofiles.open(f'{OUTPUT_PATH}/fotos_yupoo/{name_catalog}/albuns/{album}/{img_title}.jpeg', 'wb') as f:
